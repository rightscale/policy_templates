...
- *Allowed Regions* - A list of allowed regions for an applied AWS account. See the [available regions](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-regions) in AWS. If this field is left empty, then the policy will throw an error. 
